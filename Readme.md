...
* Студент: [Лариса Бережная](https://up.htmlacademy.ru/htmlcss/36/user/2223849).
* Наставник: `Пока Неизвестно, выбор недоступен`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2223849-sedona-36) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
